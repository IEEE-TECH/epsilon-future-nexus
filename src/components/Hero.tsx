  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center h-screen">
        ...
        >
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl lg:text-[90px] font-bold tracking-tighter leading-[0.9] mb-8">
              DIMENSIONS OF <br />
            ...
            <div className="flex flex-wrap gap-6">
              ...
              <a href="#tracks">
                <Button
                  variant="ghost"
                  size="lg"
                  className="h-14 px-8 rounded-none border-b border-white/10 hover:border-white/40 text-foreground hover:bg-transparent"
                >
                  Explore Tracks
                </Button>
              </a>
            ...
            <div className="mt-16 flex gap-12 border-t border-white/5 pt-8">
              <div>
                <div className="text-3xl font-bold font-display">13</div>
                <div className="text-xs text-muted-foreground uppercase tracking-widest">Feb</div>
              </div>
              <div>
              ...
              <div>
                <div className="text-3xl font-bold font-display text-primary">2026</div>
                <div className="text-xs text-muted-foreground uppercase tracking-widest">Year</div>
              </div>
            </div>
      ...
      <motion.div
        ...
        animate={{ opacity: 1 }}
        transition={{ delay: 1 }}
        className="absolute bottom-10 right-10 flex flex-col items-center gap-4 z-20"
      >
